...
while($row = mysqli_fetch_array($result)) { 
  ...
  //แก้ไขข้อมูล
  echo "<td><a href='UserUpdateForm.php?ID=$row[0]'><span class='glyphicon glyphicon-pencil'></span></a>
    
</td> ";
  //ลบข้อมูล
  echo "<td><a href='UserDelete.php?Id=$row[0]' onclick=\"return confirm('Are you sure to delete')\">
